...
class CreateTeamsTitansFullPowerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('teams_titans_full_power', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('teams_titans_full_power');
    }
}
