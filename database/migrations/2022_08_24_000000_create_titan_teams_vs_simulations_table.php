...
class CreateTitanTeamsVSSimulationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('titan_teams_vs_simulations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('titan_teams_vs_simulations');
    }
}
