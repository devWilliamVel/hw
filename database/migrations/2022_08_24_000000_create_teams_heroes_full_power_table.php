...
class CreateTeamsHeroesFullPowerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('teams_heroes_full_power', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('teams_heroes_full_power');
    }
}
