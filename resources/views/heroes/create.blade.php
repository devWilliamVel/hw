...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="text-center mb-3">{{ strtoupper(__('hero.create_hero')) }}</h2>
            </div>
            <div class="col-12 mb-3 d-flex justify-content-center align-items-baseline flex-wrap">
                ...
                <input type="text" class="input-name" id="heroName">
            </div>
            <div class="col-12 container-heroes">
                <h4 class="text-center">{{ ucfirst(__('general.very_strong_against')) }}</h4>
                <div class="d-flex justify-content-center flex-wrap mb-2" id="heroesVSA"></div>
            ...
            <div class="col-12 container-heroes">
                ...
                <div class="d-flex justify-content-center flex-wrap mb-2" id="heroesSA"></div>
                <div class="w-100 d-flex justify-content-center">
            ...
            <div class="col-12 container-heroes">
                ...
                <div class="d-flex justify-content-center flex-wrap mb-2" id="heroesVWA"></div>
                <div class="w-100 d-flex justify-content-center">
            ...
            <div class="col-12 container-heroes">
                ...
                <div class="d-flex justify-content-center flex-wrap mb-2" id="heroesWA"></div>
                <div class="w-100 d-flex justify-content-center">
        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-center mb-3">
                ...
                <div class="btn btn-success m-1" onclick="store()">{{ strtoupper(__('hero.create_hero')) }}</div>
            </div>
        </div>
    </div>
...
@section('js')
    ...
    <script>
        ...
        /*function addHero (_divHeroes, _class, _idHero, _heroName) {
            let _html = ""
                + "<div class='btn-hero'>"
                +     "<div class='d-none " + _class + "'>" + _idHero + "</div>"
                +     _heroName
                +     "<i class='fas fa-times'></i>"
                + "</div>";

            $('#' + _divHeroes).append(_html);
        }*/
        ...
        function store () {
            ...
            $.post('{{ route('hero.store') }}', _params, function (_data) {
                alert(_data.msg);

                if ( ! _data.err )
                    window.location.href = '{{ route('heroes') }}';
            });
        }
    </script>
@endsection